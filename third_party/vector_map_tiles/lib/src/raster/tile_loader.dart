...
class TileLoader {
  ...
  Future<ImageInfo> _renderTile(TileIdentity requestedTile, int requestZoom,
    ...
    // PATCH fog_of_war: si tileResponseFuture falla (p. ej. cancelación)
    // mientras aún se espera el retrieve de abajo, no tiene listener y su
    // error sube como asíncrono no manejado. ignore() lo marca como observado
    // desde ya; el await de más abajo sigue recibiendo el valor o el error.
