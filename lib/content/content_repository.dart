...
class ContentRepository {
  ...
  Future<RawContent?> readCache() async {
    try {
      ...
      return RawContent(await pois.readAsString(), await colls.readAsString());
    } catch (_) {
      return null;
    }
  }
  ...
  /// Descarga las dos pestañas de la hoja. Lanza si falla la red o el HTTP.
